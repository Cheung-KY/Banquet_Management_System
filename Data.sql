...
INSERT INTO Banquet (BIN, BanquetName, FNameContactStaff, LNameContactStaff, MinAttendee, Quota, Available, DateTime, Address, Location) VALUES
    (1, 'Spring Gala', 'Alice', 'Johnson', 5, 10, 'Y', TO_TIMESTAMP('10', 'YYYY-MM-DD HH24:MI'), '123 Blossom St', 'Hong Kong');
INSERT INTO Banquet (BIN, BanquetName, FNameContactStaff, LNameContactStaff, MinAttendee, Quota, Available, DateTime, Address, Location) VALUES
...
INSERT INTO Meal (DishName, Type, Price, SpecialCuisine, Bin) VALUES ('Shepherd Pie', 'Lamb', 220, 'Mashed Potatoes', 4);
...
CREATE TABLE Register (
                          ...
                          BIN INT NOT NULL,
                          DrinkChoice VARCHAR(255) NULL,
                          MealChoice VARCHAR(255) NULL,
